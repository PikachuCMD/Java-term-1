...
class Notebook2{
    ...
    Notebook2(String brand,String model,String cpu,int ram,int ssd,int price)
    {
       this.brand=brand;
       this.model=model;
       this.cpu=cpu;
 ...
 public static void main(String[] args)
  {
      Notebook2 mmaxmax = input();
     if(mmaxmax.CheckExpensive())
     {
        System.out.print("This notebook is expensive");
     }
     else{
        System.out.print("This notebook isn't expensive");
     }
  }

  private static Notebook2 input()
  {
      ...
      return new Notebook2(brand,model,cpu,ram,ssd,price);
  }
}
