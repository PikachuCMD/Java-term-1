...
public class MatrixCalculator {
    ...
    public Component createComponents() {
        ...
        paneMs.add(Box.createRigidArea(new Dimension(10, 0)));
        paneMs.add(MatrixPane("Value", taC));

        /* == OPERATION BUTTONS == */
        JPanel paneBtn = new JPanel();
        paneBtn.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
        paneBtn.setLayout(new GridLayout(3, 3));
        JButton btnApB = new JButton("Add");
        JButton btnAmB = new JButton("Multiply");
        JButton btnBmA = new JButton("Subtract");
        ...
        JButton btnTrnsAA = new JButton("transpose(B) = C");
        // JButton btnDetAB = new JButton("Test B");
        // JButton btnDetBC= new JButton("Test C");
        paneBtn.add(btnApB);
        paneBtn.add(btnAmB);
        paneBtn.add(btnBmA);
        paneBtn.add(btnAdjA);
        ...
        paneBtn.add(btnDetA);
        paneBtn.add(btnDetB);
        paneBtn.add(btnTrnsAA);
        // paneBtn.add(btnDetAB);
        // paneBtn.add(btnDetBC);
        ...
        btnBmA.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                try {
                    DisplayMatrix(MinMatrix(ReadInMatrix(taA), ReadInMatrix(taB)), taC);
                } catch (Exception e) {
                    System.err.println("Error: " + e);
                }
            }
        ...
        btnTrnsAA.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                try {
                    DisplayMatrix(Transposeb(ReadInMatrix(taB)), taC);
                } catch (Exception e) {
                    System.err.println("Error: " + e);
                }
            }
    ...
    public float[][] MinMatrix(float[][] a, float[][] b) throws Exception {
        int tms = a.length;
        int tmsB = b.length;
        if (tms != tmsB) {
            statusBar.setText("Matrix Size Mismatch");
    ...
    public float[][] Transposeb(float[][] b) {
        if (INFO) {
            System.out.println("Performing Transpose...");
        }
        int tms = b.length;
